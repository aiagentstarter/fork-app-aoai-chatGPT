...
| App Setting | Required? | Default Value | Note |
|---|---|---|---|
|UI_TITLE|No|Chat| Chat title (left-top) and page title (HTML)
|UI_LOGO|No|| Logo (left-top). Configure the URL to your logo image.
|UI_CHAT_LOGO|No|| Logo (chat window). Configure the URL to your logo image.
...
|UI_FAVICON|No|| Configure the URL to your favicon.
